...
- [`auth-bridge`](./auth-bridge): 웹 OIDC만 지원하는 사내 IdP를 Keycloak Device Flow에 연결하는 독립 프로젝트 ([사내 포팅 가이드](./auth-bridge/docs/company-porting-guide.ko.md), [Resource Server 연동 가이드](./auth-bridge/docs/resource-server-integration-guide.ko.md))
